  ...
  return (
    <>
      ...
      {/* <div className={`${open ? 'pop-card open': 'pop-card'} `}>
        ...
        <a className="wtrvl-checkout_button button" id="wetravel_button_widget" data-env="https://www.wetravel.com" data-version="v0.3" data-uid="1154190" data-uuid="83061662" href="https://www.wetravel.com/trips/mexico-magic-skydancer-yoga-8341447052" target="_blank">Book Now</a> 
