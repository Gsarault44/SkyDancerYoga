...
export const blogs = [
  ...
  {
    title: 'Rain',
    excerpt: 'Cleansing the earth and yourself with rain.',
  ...
  {
    title: 'Guatemala',
    excerpt: 'Volunteering in Latin America',
      ...
      <main className={`blog`}>
        ...
        <section className="blog">
          <div className="blog-content">
            ...
            <div className="blog-body" dangerouslySetInnerHTML={{ __html: blogs[2].content }}/>
          </div>
        </section>
      </main>
    </>
